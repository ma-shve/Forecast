DECLARE @StartDateNew DATETIME = DATETIME2FROMPARTS(2018,11,01,00,00,00,00,00)/*(2018,01,01)*/
DECLARE @EndTime DATETIME = DATETIME2FROMPARTS(2018,11,30,00,00,00,00,00)/*(2018,05,31)*/
...
WHERE 	
	(T1._Fld725 = 0.0)	
	/*AND T3._Description = 'Центральный'*/
	AND (T2._Fld3394 = '1016')	
